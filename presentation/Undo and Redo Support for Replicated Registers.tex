...
\newcommand{\registerx}[1]{
  \begin{tikzpicture}[]
    ...
    \node[font=\Large] (empty) at (0,0.46) {$\bot$};
    \foreach \x [count=\i] in #1 {%
      \ifnum\i=1%
        \node[double,sitem,draw,fill=white] (s\i) at (0,0.59*\i) {\x};
      \else%
...
\newcommand{\userstate}[4]{
  ...
  \begin{tikzpicture}[]
    ...
    \node[label={[slabel]below:register},right=\stackdist of redostack.south east,anchor=south west] (register) {\stack{#4}};
...
\section{Part III: Experimental Evaluation}
