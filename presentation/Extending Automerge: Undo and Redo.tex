    ...
    \begin{adjustbox}{max totalsize={\textwidth}{0.75\textheight},center}
      \begin{tikzpicture}[node distance=0.23cm]
        ...
        \node [fill=white,anchor=center,draw,rounded corners] at (4.2,-2.0) {
            \includegraphics[height=30px]{gsheets.png}
            \includegraphics[height=30px]{gslides.png}
            \includegraphics[height=30px]{figma.png}
            \includegraphics[height=30px]{powerpoint.png}
            \includegraphics[height=30px]{excel.png}
            \only<10>{
              \includegraphics[height=30px]{miro.png}%
            }
            \only<11>{
              \includegraphics[height=30px]{miro_crossed_out.png}%
            }
        };
        }
