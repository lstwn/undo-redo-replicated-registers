...
% according to https://trevorcampbell.me/html/arxiv.html
% the next line is required to convince Arxiv's pdflatex 
% to build a proper PDF; welcome to the stone age of computing :)
