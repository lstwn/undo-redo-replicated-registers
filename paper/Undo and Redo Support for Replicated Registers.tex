...
ancestors to arrive first, if necessary, and then adds the new operation to its
operation history.
...
\begin{tikzpicture}[node distance=50pt]
  ...
  \begin{scope}[on background layer]
  \node[op,right of=b9] (b10) {\redop{10}{B}{5}{B}} edge [pred] (b9) edge [anchorref,bend right=4] (b5);
  \end{scope}
...
%% TODO: update link below after merging into main
...
origin\footnote{\url{https://github.com/lstwn/undo-redo-replicated-registers/blob/332467e6cec918dd66b92e570ece8e8bfa077b00/surveys/yjs/src/yjs.test.ts}}.
