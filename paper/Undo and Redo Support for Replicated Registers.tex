...
\begin{tikzpicture}[node distance=0.23cm]
  ...
  \def\red{red}
  \def\upperoffset{38pt}
  \def\loweroffset{300pt}
  \def\casemargin{1.32cm}
  \def\caselabeldist{17pt}
  ...
  \coordinate (d1e) at ($(5a.south)!0.5!(5b.south)+(0,0)$);

  \coordinate (d2s) at ($(1b.north)!0.5!(1c.north)+(0,+\upperoffset)$);
  \coordinate (d2e) at ($(5b.south)!0.5!(5c.south)+(0,0)$);

  \coordinate (d3s) at ($(1c.north)!0.5!(1d.north)+(0,+\upperoffset)$);
  \coordinate (d3e) at ($(5c.south)!0.5!(5d.south)+(0,0)$);

  \coordinate (d4s) at ($(1d.north)!0.5!(1e.north)+(0,+\upperoffset)$);
  \coordinate (d4e) at ($(5d.south)!0.5!(5e.south)+(0,0)$);
  ...
  \node[caselabel,above=\caselabeldist of 1c] {
    (1) Two registers, global undo
  };

  \node[caselabel,above=\caselabeldist of 2c] {
    (2) Two registers, local undo
  };

  \node[caselabel,above=\caselabeldist of 3c] {
    (3) One register, global undo
  };

  \node[caselabel,above=\caselabeldist of 4c] {
    (4) One register, local undo
  };

  \node[caselabel,above=\caselabeldist of 5c] {
    (5) One register, remote operation blocks undo
  };
