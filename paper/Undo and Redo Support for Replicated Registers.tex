...
%% TODO: median
The figure shows the mean runtime to resolve the head(s) to the
...
The findings show that without caching there is a linear runtime w.r.t. $n$.
...
the price to pay for the traversal may be acceptable,
