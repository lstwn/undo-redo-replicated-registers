...
%% TODO: make local undo more convincing
%% - consistent with multi register case
%% - global undo implicitly assumes that a user is aware of all remote changes
%%   but the weakest assumption we can reasonably do is to assume that he is aware
%%   of his own changes
%% - technical challenges and stack semantics in eventually consistent systems
%%   (refer to appendix) out of order delivery
